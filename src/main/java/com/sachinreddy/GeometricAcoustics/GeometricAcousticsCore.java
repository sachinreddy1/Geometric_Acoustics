...
public class GeometricAcousticsCore implements IClassTransformer
{
	...
	public static class Config
	{
		...
		public static boolean convolution = false;
	...
	public static void syncConfig()
	{
		...
		Config.convolution = configFile.getBoolean("Convolution", Configuration.CATEGORY_GENERAL, false, "A value controlling the method of calculating gain values.");
